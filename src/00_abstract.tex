...
QUIC should prevent these attacks because these attacks assist an adversary
...
There are three advantages in the our proposed scheme.
First, it prevents the attacks.
Second, it does not require Strong Computational Diffie-Hellman~\cite{ABR01}
...
Third, it reduces a number of interactions from four times
to two times.
\end{abstract}